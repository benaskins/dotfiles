...
dir_segment=$(printf '\033[97;44m ^ %s %s \033[0m' "$(hostname -s)" "$cwd")
...
# Build output: directory (with hostname), then branch (mirrors shell layout), then model + context
output="$dir_segment  $time_segment"
